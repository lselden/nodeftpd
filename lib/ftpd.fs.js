 ...
 * regardless of operating system (i.e. works on Windows)
 *
 *
 * @param {object} options - configuration options include:
 * 		{string} root - root directory for actual filesystem.  default is cwd
 *		{string} cwd  - starting relative directory
 *		{boolean} autocreateDirectories - special option to automatically create folders on an
 *                      as-needed basis, rather than throwing an error if directory doesn't exist
 *
 */
...
(function () {
	...
	// make directory.  if parent folder doesn't exist create as well
	// i.e. new/folders/here will create new, and new/folders, and new/folders/here
